...
//TODO: implement for Image * type in overloaded function
...
bool PerPixelCollisionStrategy::executeWeapon(
  ...
  const SDL_Surface* temp1 = obj1.getWeaponSurface();
  SDL_Surface* surface1 = scaleSurface(temp1, width1, height1);
  const SDL_Surface* temp2 = obj2.getSurface();
  SDL_Surface* surface2 = scaleSurface(temp2, width2, height2);
...
bool PerPixelCollisionStrategy::executeBorder(
  ...
  const SDL_Surface* temp1 = obj1.getBorderSurface();
  SDL_Surface* surface1 = scaleSurface(temp1, width1, height1);
  const SDL_Surface* temp2 = obj2.getBorderSurface();
  SDL_Surface* surface2 = scaleSurface(temp2, width2, height2);
